...
declare module '$env/static/private' {
	...
	export const EXPORT_BUCKET: string;
	export const ORGANIZATION_SEED_UUID: string;
	...
	export const npm_package_dependencies__kbook_shared: string;
	...
	export const npm_package_dependencies__kbook_offline_core: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__kbook_shared: string;
		PWD: string;
		...
		npm_package_dependencies__kbook_offline_core: string;
